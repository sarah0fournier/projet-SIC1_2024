// node_modules/aframe-html-shader/dist/aframe-html-shader.js
(function(modules) {
  ...
  function(module, exports, __webpack_require__) {
    ...
    function createError(err, target) {
      return { status: "error", target, message: err, timestamp: Date.now() };
    }
    AFRAME.registerShader("html", {
      ...
      __updateTexture: function __updateTexture(data) {
        var _this = this;
        var target = data.target, fps = data.fps, width = data.width, height = data.height, ratio = data.ratio;
        this.__width = width || this.schema.width.default;
        this.__height = height || this.schema.height.default;
        var resetDebug = function resetDebug2() {
          if (_this.__debugEl) {
      ...
      __validateSrc: function __validateSrc(target, cb) {
        ...
        if (el.error) {
          ...
          if (tagName === "img" || tagName === "video") {
            ...
            cb({ status: "success", target, targetEl: el, timestamp: Date.now() });
          }
        }
        if (message) {
      ...
      __draw: function __draw(canvas) {
        ...
        this.__texture.needsUpdate = true;
        if (this.__ratio) {
          var _el$getObject3D$geome = this.el.getObject3D("mesh").geometry.metadata.parameters, width = _el$getObject3D$geome.width, height = _el$getObject3D$geome.height;
      ...
      __render: function __render() {
        ...
        var _targetEl$getBoundin = this.__targetEl.getBoundingClientRect(), width = _targetEl$getBoundin.width, height = _targetEl$getBoundin.height;
      ...
      __setNextTick: function __setNextTick() {
        if (this.__fps > 0) {
          this.__nextTime = Date.now() + 1e3 / this.__fps;
        }
      },
      /*============================
      =            ready           =
      ...
      __ready: function __ready(_ref) {
        var target = _ref.target, targetEl = _ref.targetEl;
        log("__ready");
        this.__target = target;
  ...
  function(module, exports, __webpack_require__) {
    ...
    function html2canvas(nodeList, options) {
      ...
      options.imageTimeout = typeof options.imageTimeout === "undefined" ? 1e4 : options.imageTimeout;
    ...
    function renderDocument(document2, options, windowWidth, windowHeight, html2canvasIndex) {
      return createWindowClone(document2, document2, windowWidth, windowHeight, options, document2.defaultView.pageXOffset, document2.defaultView.pageYOffset).then(function(container) {
        log("Document cloned");
        var attributeName = html2canvasNodeAttribute + html2canvasIndex;
        var selector = "[" + attributeName + "='" + html2canvasIndex + "']";
        document2.querySelector(selector).removeAttribute(attributeName);
  ...
  function(module, exports) {
    "use strict";
    function Support(document2) {
      this.rangeBounds = this.testRangeBounds(document2);
      this.cors = this.testCORS();
      this.svg = this.testSVG();
    }
    Support.prototype.testRangeBounds = function(document2) {
      var range, testElement, rangeBounds, rangeHeight, support = false;
      if (document2.createRange) {
        range = document2.createRange();
        if (range.getBoundingClientRect) {
          testElement = document2.createElement("boundtest");
  ...
  function(module, exports, __webpack_require__) {
    "use strict";
    var log = __webpack_require__(5);
    function Renderer(width, height, images, options, document2) {
      this.width = width;
      this.height = height;
      this.images = images;
  ...
  function(module, exports) {
    ...
    var logger = function logger2() {
      if (logger2.options.logging && window.console && window.console.log) {
        Function.prototype.bind.call(window.console.log, window.console).apply(window.console, [Date.now() - logger2.options.start + "ms", "html2canvas:"].concat([].slice.call(arguments, 0)));
      }
    };
  ...
  function(module, exports, __webpack_require__) {
    ...
    function Proxy(src, proxyUrl, document2) {
      ...
      return supportsCORS ? XHR(url) : jsonp(document2, url, callback).then(function(response) {
        return decode64(response.content);
      });
    }
    var proxyCount = 0;
    function ProxyURL(src, proxyUrl, document2) {
      var supportsCORSImage = "crossOrigin" in new Image();
      var callback = createCallback(supportsCORSImage);
      var url = createProxyUrl(proxyUrl, src, callback);
      return supportsCORSImage ? Promise.resolve(url) : jsonp(document2, url, callback).then(function(response) {
        return "data:" + response.type + ";base64," + response.content;
      });
    }
    function jsonp(document2, url, callback) {
      return new Promise(function(resolve, reject) {
        var s = document2.createElement("script");
        var cleanup = function cleanup2() {
          delete window.html2canvas.proxy[callback];
          document2.body.removeChild(s);
        };
        ...
        document2.body.appendChild(s);
      });
    }
    function createCallback(useCORS) {
      return !useCORS ? "html2canvas_" + Date.now() + "_" + ++proxyCount + "_" + Math.round(Math.random() * 1e5) : "";
    }
    ...
    function loadUrlDocument(src, proxy, document2, width, height, options) {
      return new Proxy(src, proxy, window.document).then(documentFromHTML(src)).then(function(doc) {
        return createWindowClone(doc, document2, width, height, options, 0, 0);
      });
    }
    exports.Proxy = Proxy;
  ...
  function(module, exports, __webpack_require__) {
    ...
    function FrameContainer(container, sameOrigin, options) {
      ...
      this.promise = (!sameOrigin ? this.proxyLoad(options.proxy, bounds, options) : new Promise(function(resolve) {
        ...
        return html2canvas(container2.contentWindow.document.documentElement, { type: "view", width: container2.width, height: container2.height, proxy: options.proxy, javascriptEnabled: options.javascriptEnabled, removeContainer: options.removeContainer, allowTaint: options.allowTaint, imageTimeout: options.imageTimeout / 2 });
  ...
  function(module, exports, __webpack_require__) {
    ...
    NodeParser.prototype.createPseudoHideStyles = function(document2) {
      this.createStyles(document2, "." + PseudoElementContainer.prototype.PSEUDO_HIDE_ELEMENT_CLASS_BEFORE + ':before { content: "" !important; display: none !important; }.' + PseudoElementContainer.prototype.PSEUDO_HIDE_ELEMENT_CLASS_AFTER + ':after { content: "" !important; display: none !important; }');
    };
    NodeParser.prototype.disableAnimations = function(document2) {
      this.createStyles(document2, "* { -webkit-animation: none !important; -moz-animation: none !important; -o-animation: none !important; animation: none !important; -webkit-transition: none !important; -moz-transition: none !important; -o-transition: none !important; transition: none !important;}");
    };
    NodeParser.prototype.createStyles = function(document2, styles) {
      if (window.hidePseudoElementsAdded) {
        return;
      }
      window.hidePseudoElementsAdded = true;
      var hidePseudoElements = document2.createElement("style");
      hidePseudoElements.innerHTML = styles;
      document2.body.appendChild(hidePseudoElements);
    };
    ...
    NodeParser.prototype.paintFormValue = function(container) {
      ...
      if (value.length > 0) {
        var document2 = container.node.ownerDocument;
        var wrapper = document2.createElement("html2canvaswrapper");
        ...
        document2.body.appendChild(wrapper);
        this.paintText(new TextContainer(wrapper.firstChild, container));
        document2.body.removeChild(wrapper);
      }
    };
  ...
  function(module, exports, __webpack_require__) {
      ...
      (function(root) {
        ...
        if (true) {
          !(__WEBPACK_AMD_DEFINE_RESULT__ = (function() {
            return punycode;
          }).call(exports, __webpack_require__, exports, module2), __WEBPACK_AMD_DEFINE_RESULT__ !== void 0 && (module2.exports = __WEBPACK_AMD_DEFINE_RESULT__));
    ...
    }).call(exports, __webpack_require__(23)(module), /* @__PURE__ */ function() {
      return this;
    }());
  },
  /* 23 */
  ...
  function(module, exports, __webpack_require__) {
    ...
    FontMetrics.prototype.getMetrics = function(family, size) {
      if (this.data[family + "-" + size] === void 0) {
...
aframe-html-shader/dist/aframe-html-shader.js:
  (*! https://mths.be/punycode v1.4.1 by @mathias *)
*/
//# sourceMappingURL=aframe-html-shader.js.map
